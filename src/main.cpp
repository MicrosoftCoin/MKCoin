...
uint256 hashGenesisBlock("0xf3896920c36913b43a99f9f433b62796e91b80ecb5c837151c8b05365bb0707c");
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // mkcoin: 1 days
static const int64 nTargetSpacing = 120; // mkcoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal mkcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "mkcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "You must notify us in writing within 30 days";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1392864858; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1901655;
        ...
        assert(block.hashMerkleRoot == uint256("0xfad1928b859f713168aa5ac49c58c8087677a9bb6c9e26542111f1f53e1e4a92"));
